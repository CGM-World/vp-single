...
#SBATCH --job-name run_specgen_1e5
...
#SBATCH --mem=40G ## Memory allocated for the job
#SBATCH --time=4-00:00:00  ## time for analysis (day-hour:min:sec)

# Set Env Vars
SIF="/fs1/project/cgm_world/apptainer/tensorflow_2.9.2_custom.sif"

# Run Program
apptainer exec --nv "$SIF" python specgen.py 100000
