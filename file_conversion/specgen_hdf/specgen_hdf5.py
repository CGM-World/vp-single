...
for i in pbar(range(init_pars.shape[0])):
    ...
    # Old:
    # append snr, 2796 seed, and 2803 seed to noise log file
    # noisefile = open("noise_log_.txt", "a+")
...
print("noise_log shape: ", noise_log_df.shape)
print("MgII2796 shape: ", MgII2796_df.shape)
print("MgII2803 shape: ", MgII2803_df.shape)

# print("labels dtype: ", labels_df.dtype)
# print("noise_log dtype: ", noise_log_df.dtype)
# print("MgII2796 dtype: ", MgII2796_df.dtype)
# print("MgII2803 dtype: ", MgII2803_df.dtype)
...
# For debugging: check that it worked
with h5py.File('data.h5', 'r') as hdf:
    labels_new = np.array(hdf.get('labels'))
    noise_log_new = np.array(hdf.get('noise_log'))
    MgII2796_new = np.array(hdf.get('MgII2796'))
    MgII2803_new = np.array(hdf.get('MgII2803'))
